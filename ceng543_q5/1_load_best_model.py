...
Selected: Transformer + DistilBERT (Q3) with BLEU 6.49
"""
...
def load_best_model():
    ...
    print("  BLEU: 6.49")
    print("  ROUGE-L: 0.6355")
    print("  Task: Multi30k EN→DE Translation")
    
    # Path to Q3 best checkpoint
    q3_checkpoint = "../ceng543_q3/q3_experiments/transformer_distilbert_L3H8/checkpoints/best.pt"
    ...
    best_bleu = checkpoint.get('best_bleu', checkpoint.get('bleu', 6.49))
    if not isinstance(best_bleu, (int, float)):
        best_bleu = 6.49  # Default from Q3 results
