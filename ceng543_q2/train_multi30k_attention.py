...
trg_stoi, trg_itos = build_vocab(train, "de", MAX_VOCAB)
...
train_dl = DataLoader(MTDataset(train, src_stoi, trg_stoi), batch_size=BATCH, shuffle=True, collate_fn=collate_fn)
valid_dl = DataLoader(MTDataset(valid, src_stoi, trg_stoi), batch_size=BATCH, shuffle=False, collate_fn=collate_fn)
test_dl  = DataLoader(MTDataset(test,  src_stoi, trg_stoi), batch_size=BATCH, shuffle=False, collate_fn=collate_fn)
