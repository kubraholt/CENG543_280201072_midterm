...
def generate_qualitative_report():
    ...
    with open("outputs/bm25_rag_results.json", "r") as f:
    ...
    report_lines.append("Analysis of BM25 + FLAN-T5-base RAG system outputs.\n")
    ...
    for category, target in target_counts.items():
        ...
        for idx, (result, metadata) in enumerate(selected, 1):
            ...
            report_lines.append("**Retrieved Passages** (BM25 Top-3):\n")
