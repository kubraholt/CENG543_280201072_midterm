...
def plot_retrieval_comparison():
    ...
    bm25_precision = [metrics['bm25'][f'P@{k}'] for k in k_values]
    bm25_recall = [metrics['bm25'][f'R@{k}'] for k in k_values]
    ...
    ax1.plot(k_values, bm25_precision, marker='o', linewidth=2, label='BM25')
    ...
    ax2.plot(k_values, bm25_recall, marker='o', linewidth=2, label='BM25')
...
def plot_retrieval_generation_correlation():
    ...
    systems = ['BM25 + FLAN-T5-base', 'SBERT + FLAN-T5-base']
    retrieval_names = ['bm25', 'sbert']
