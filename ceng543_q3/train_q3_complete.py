...
class MTDataset(Dataset):
    ...
    def __init__(self, hf_dataset, src_stoi, trg_stoi, src_lang='en', trg_lang='de'):
...
class MTDatasetBERT(Dataset):
    ...
    def __init__(self, hf_dataset, bert_tokenizer, trg_stoi, src_lang='en', trg_lang='de', max_len=100):
        self.examples = hf_dataset
...
trg_stoi, trg_itos = build_vocab(train, 'de', args.max_vocab)
...
# =============================================================================
if is_bert_mode:
    train_ds = MTDatasetBERT(train, bert_tokenizer, trg_stoi, max_len=args.max_len)
    valid_ds = MTDatasetBERT(valid, bert_tokenizer, trg_stoi, max_len=args.max_len)
    test_ds = MTDatasetBERT(test, bert_tokenizer, trg_stoi, max_len=args.max_len)
else:
    train_ds = MTDataset(train, src_stoi, trg_stoi)
    valid_ds = MTDataset(valid, src_stoi, trg_stoi)
    test_ds = MTDataset(test, src_stoi, trg_stoi)
